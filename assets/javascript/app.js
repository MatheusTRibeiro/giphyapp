...
for (let i = 0; i < animals.length; i++) {
    ...
    var appendAnimal = $("<button>");

    appendAnimal.addClass("animal");

    appendAnimal.attr("data-animal", animalName);

    appendAnimal.text(animalName);

    $("#buttonsHolder").append(appendAnimal);
